...
<head>
    ...
    <style>
        body{display:flex;align-items:center;justify-content:center;height:100vh;margin:0;flex-direction:column;}form{text-align:center;}label{margin-bottom:10px;}#productForm{display:none;width:80%;}.default-option{color:#999;}table{border-collapse:collapse;width:100%;margin-top:10px;}th,td{border:1px solid black;padding:8px;text-align:center;}#grandTotal{margin-top:10px;}#vendorDetails{margin-top:20px;}#bankDetails{margin-top:20px;}#addProductButton{margin-top:10px;}
    </style>
</head>
<body>
    ...
    <form method="post" action="generate_pdf.php">
        ...
        <select name="dropdown2" id="dropdown2" onchange="showProductForm('dropdown2'); updateVendorDetails()">
            <option value="" class="default-option">Type here to search</option>
            <option value="vinay_computers" data-name="Vinay Computers" data-mobile="1234567890" data-address="hadapsar, pune">Vinay Computers</option>
        </select>
            ...
            <table class="table table-bordered">
                ...
                <tbody id="product_tbody">
                    <tr>
                        ...
                        <td><input type="text" required name="price[]" class="form-control price" oninput="calculateTotal(this)"></td>
                        <td><input type="text" required name="qty[]" class="form-control qty" oninput="calculateTotal(this)"></td>
                        <td><input type="text" required name="total[]" class="form-control total" readonly></td>
                        <td><input type="button" value="x" class="btn btn-danger btn-sm btn-row-remove" onclick="removeRow(this)"> </td>
                    </tr>
                </tbody>
                <tfoot>
                    <tr>
                        <td><input type="button" value="+ Add Row" class="btn btn-primary btn-sm" id="btn-add-row" onclick="addRowWithProduct()"></td>
                        <td colspan="2" class="text-right">Total</td>
                        <td><input type="text" name="grand_total" id="grand_total" class="form-control" readonly required></td>
                    </tr>
                </tfoot>
            </table>
